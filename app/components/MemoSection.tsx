    ...
    >
      <div className="mb-5 sm:mb-7 flex flex-wrap items-center justify-between gap-2 sm:gap-4">
        <div className="flex items-center gap-2.5 sm:gap-3.5">
          <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-sm bg-[#425828]/10 font-mono text-xs font-bold text-[#425828]">
            {number}
          </span>
          <h3 className="font-display text-xl sm:text-2xl font-semibold tracking-[-0.03em] text-[#121614]">
            {title}
          </h3>
        </div>
