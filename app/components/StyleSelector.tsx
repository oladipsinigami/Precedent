    ...
    <div>
      <div className="flex items-center justify-between">
        ...
        <span className="font-mono text-[10px] text-[#556472]">
          Re-weights narrative perspective
        </span>
      </div>
        ...
        {stylesList.map((item) => {
          ...
          return (
            <button
              ...
              className={`group relative flex flex-col justify-between rounded-sm border p-3 text-left transition-all duration-150 ${
                isSelected
            ...
            >
              ...
              <div className="mt-3 flex items-center gap-1.5 font-mono text-[9px] uppercase tracking-wider text-[#526270]">
                <span>Analog:</span>
                <span className={isSelected ? "text-[#d4ff3f]" : "text-[#8394a4]"}>
                  {profile.analogHorizon} horizon
                </span>
              </div>
            </button>
          );
